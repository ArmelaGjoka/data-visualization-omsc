...
def author():                                                                                             
        return "agjoka3" # replace gburdell3 with your Georgia Tech username.                                                                                             
                                                                                              
def gtid():                                                                                               
    return 903386342 # replace with your GT ID number      
...
class PageRank:
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        for it in range(iterations):
            ...
            pr_values  = (1 - damping_factor) * node_weights + [new_value * damping_factor for new_value in new_pr_values]       
